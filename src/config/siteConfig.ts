...
export const siteConfig: SiteConfig = {
  ...
  description:
    "Becore 是一款基于 Astro 框架和 Fuwari 模板开发的清新美观且现代化个人博客主题模板，专为技术爱好者和内容创作者设计。该主题融合了现代 Web 技术栈，提供了丰富的功能模块和高度可定制的界面，让您能够轻松打造出专业且美观的个人博客网站。",
  keywords: [
    "Firefly",
    "Fuwari",
    "Astro",
  ...
  navbarTitle: "Becore", // 导航栏标题，可以设置为与 title 不同的值，如果不设置则使用 title
  ...
  backgroundWallpaper: {
    ...
    banner: {
      ...
      homeText: {
        ...
        // 主页横幅副标题
        subtitle: [
          "Passion first, code with heart",
          "Create not just code, but a shining story",
          "Chase passion, code boldly, and never fade",
          "Go beyond limits—build what lights you up",
          "Chase what fuels you, never dim your glow",
          "Turn moments of joy into lifelong memories"
        ],
        typewriter: {
          //打字机开启 → 循环显示所有副标题
          //打字机关闭 → 每次刷新随机显示一条副标题
